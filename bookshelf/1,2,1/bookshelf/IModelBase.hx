...
typedef IModelBase<T> = {
	...
	**/
	...
	function on(?event:String, ?callback:EventFunction<ts.AnyOf2<Collection<T>, T>>, ?context:Dynamic):Void;
	...
	function once(event:String, callback:EventFunction<ts.AnyOf2<Collection<T>, T>>, ?context:Dynamic):Void;
	/**
