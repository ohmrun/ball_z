...
typedef Request<P, ResBody, ReqBody, ReqQuery, Locals> = {
	...
	**/
	@:optional
	var res : Response<ResBody, Locals, Float>;
	@:optional
	...
	**/
	...
	function setEncoding(encoding:global.BufferEncoding):Request<P, ResBody, ReqBody, ReqQuery, Locals>;
	...
	function wrap(oldStream:global.nodejs.ReadableStream):Request<P, ResBody, ReqBody, ReqQuery, Locals>;
	...
	**/
	...
	function off(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Request<P, ResBody, ReqBody, ReqQuery, Locals>;
	function removeAllListeners(?event:ts.AnyOf2<String, js.lib.Symbol>):Request<P, ResBody, ReqBody, ReqQuery, Locals>;
