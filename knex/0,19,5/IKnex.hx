typedef IKnex<TRecord, TResult> = {
	@:selfCall
	function call_<TRecord2, TResult2>(?tableName:ts.AnyOf4<String, knex.Raw<Dynamic>, knex.QueryBuilder<Dynamic, Array<Dynamic>>, knex.AliasDict>):knex.QueryBuilder<TRecord2, TResult2>;
	@:selfCall
	function call<TRecord, TResult>(config:ts.AnyOf2<String, knex.Config>):Knex<TRecord, TResult>;
	var VERSION : String;
	var __knex__ : String;
