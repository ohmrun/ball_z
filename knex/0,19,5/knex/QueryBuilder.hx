...
@:jsRequire("knex", "QueryBuilder") extern class QueryBuilder<TRecord, TResult> {
	function new();
	var or : QueryBuilder<TRecord, TResult>;
	var not : QueryBuilder<TRecord, TResult>;
	var and : QueryBuilder<TRecord, TResult>;
	function columnInfo(?column:Dynamic):js.lib.Promise<ColumnInfo>;
	@:overload(function(tableNames:Array<String>):QueryBuilder<TRecord, TResult> { })
	function forUpdate(tableNames:haxe.extern.Rest<String>):QueryBuilder<TRecord, TResult>;
	@:overload(function(tableNames:Array<String>):QueryBuilder<TRecord, TResult> { })
	function forShare(tableNames:haxe.extern.Rest<String>):QueryBuilder<TRecord, TResult>;
	function skipLocked():QueryBuilder<TRecord, TResult>;
	function noWait():QueryBuilder<TRecord, TResult>;
	function toSQL():Sql;
	function on(event:String, callback:haxe.Constraints.Function):QueryBuilder<TRecord, TResult>;
	function queryContext(context:Dynamic):QueryBuilder<TRecord, TResult>;
	function clone():QueryBuilder<TRecord, TResult>;
	function timeout(ms:Float, ?options:{ @:optional var cancel : Bool; }):QueryBuilder<TRecord, TResult>;
	...
	function options(options:{ }):QueryBuilder<TRecord, TResult>;
	function connection(connection:Dynamic):QueryBuilder<TRecord, TResult>;
	function debug(enabled:Bool):QueryBuilder<TRecord, TResult>;
	function transacting(trx:Transaction<Dynamic, Dynamic>):QueryBuilder<TRecord, TResult>;
	...
	function asCallback(callback:haxe.Constraints.Function):QueryBuilder<TRecord, TResult>;
	/**
	...
	**/
	...
	static var prototype : QueryBuilder<Dynamic, Dynamic>;
	static function extend(methodName:String, fn:(args:haxe.extern.Rest<Dynamic>) -> QueryBuilder<Any, Any>):Void;
}