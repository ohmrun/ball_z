...
typedef Transaction<TRecord, TResult> = {
	@:selfCall
	function call<TRecord2, TResult2>(?tableName:ts.AnyOf4<String, Raw<Dynamic>, QueryBuilder<Dynamic, Array<Dynamic>>, AliasDict>):QueryBuilder<TRecord2, TResult2>;
	var executionPromise : js.lib.Promise<TResult>;
	dynamic function isCompleted():Bool;
	function query<TRecord, TResult>(conn:Dynamic, sql:Dynamic, status:Dynamic, value:Dynamic):QueryBuilder<TRecord, TResult>;
	function savepoint<T>(transactionScope:(trx:Transaction<Dynamic, Dynamic>) -> Dynamic):js.lib.Promise<T>;
	function commit(?value:Dynamic):QueryBuilder<TRecord, TResult>;
	function rollback(?error:Dynamic):QueryBuilder<TRecord, TResult>;
	var VERSION : String;
	var __knex__ : String;
	@:overload(function<TResult2>(sql:String, bindings:haxe.extern.Rest<RawBinding>):Raw<TResult2> { })
	@:overload(function<TResult2>(sql:String, bindings:ts.AnyOf2<Array<RawBinding>, ValueDict>):Raw<TResult2> { })
	dynamic function raw<TResult2>(value:Value):Raw<TResult2>;
	function transactionProvider(?config:Dynamic):() -> js.lib.Promise<Transaction<Dynamic, Dynamic>>;
	@:overload(function<T>(transactionScope:(trx:Transaction<Dynamic, Dynamic>) -> ts.AnyOf2<Void, js.lib.Promise<T>>, ?config:Dynamic):js.lib.Promise<T> { })
	function transaction(?transactionScope:Any, ?config:Dynamic):js.lib.Promise<Transaction<Dynamic, Dynamic>>;
	function initialize(?config:Config):Void;
	@:overload(function():js.lib.Promise<Void> { })
	function destroy(callback:haxe.Constraints.Function):Void;
	function batchInsert(tableName:TableDescriptor, data:Array<Dynamic>, ?chunkSize:Float):QueryBuilder<TRecord, { }>;
	var schema : SchemaBuilder;
	function queryBuilder<TRecord2, TResult2>():QueryBuilder<TRecord2, TResult2>;
	var client : Dynamic;
	var migrate : Migrator;
	var seed : Seeder;
	var fn : FunctionHelper;
	dynamic function ref<TSrc>(src:TSrc):Ref<TSrc, Dynamic>;
	...
	function addListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transaction<TRecord, TResult>;
	function on(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transaction<TRecord, TResult>;
	function once(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transaction<TRecord, TResult>;
	function removeListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transaction<TRecord, TResult>;
	function off(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transaction<TRecord, TResult>;
	function removeAllListeners(?event:ts.AnyOf2<String, js.lib.Symbol>):Transaction<TRecord, TResult>;
	function setMaxListeners(n:Float):Transaction<TRecord, TResult>;
	...
	function prependListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transaction<TRecord, TResult>;
	function prependOnceListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transaction<TRecord, TResult>;
