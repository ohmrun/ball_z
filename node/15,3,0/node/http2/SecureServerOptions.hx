...
typedef SecureServerOptions = {
	...
	var Http1IncomingMessage : {
		...
		**/
		...
		@:overload(function(emitter:SecureServerOptions, event:String, ?options:SecureServerOptions):js.lib.Promise<Array<Dynamic>> { })
		function once(emitter:SecureServerOptions, event:ts.AnyOf2<String, js.lib.Symbol>, ?options:SecureServerOptions):js.lib.Promise<Array<Dynamic>>;
		function on(emitter:global.nodejs.EventEmitter, event:String, ?options:SecureServerOptions):js.lib.AsyncIterableIterator<Dynamic>;
		function listenerCount(emitter:global.nodejs.EventEmitter, event:ts.AnyOf2<String, js.lib.Symbol>):Float;
		/**
			Returns a list listener for a specific emitter event name.
		**/
		function getEventListener(emitter:ts.AnyOf2<global.nodejs.EventEmitter, SecureServerOptions>, name:ts.AnyOf2<String, js.lib.Symbol>):Array<haxe.Constraints.Function>;
		/**
