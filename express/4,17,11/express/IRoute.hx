...
typedef IRoute = {
	...
	@:overload(function<P, ResBody, ReqBody, ReqQuery, Locals>(handlers:haxe.extern.Rest<express_serve_static_core.RequestHandler<P, ResBody, ReqBody, ReqQuery, Locals>>):IRoute { })
	@:overload(function<P, ResBody, ReqBody, ReqQuery, Locals>(handlers:haxe.extern.Rest<express_serve_static_core.RequestHandlerParams<P, ResBody, ReqBody, ReqQuery, Locals>>):IRoute { })
